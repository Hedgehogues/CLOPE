...
testVkDynamicRepulsion.py -- тестирование изменения параметра отталкивания. Разбиваем данные на кластеры с удалением
шума. После разбиения, увеличиваем repulsion. Результаты показали, что алгоритм сходится к единственному разбиению.